# Generated by Django 4.2.6 on 2024-03-18 08:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(101, 'requested'), (102, 'accepted'), (103, 'in progress'), (104, 'completed'), (105, 'cancelled')], default=v1.ride.constants.RideStatus['requested'], max_length=20)),
                ...
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rides_as_driver', to='ride.driver')),
                ('pickup_coordinate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ride.locationcoordinates')),
        ...
        migrations.AddField(
            model_name='driver',
            name='coordinate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ride.locationcoordinates'),
        ),
        migrations.AddField(
            model_name='driver',
            name='user',
